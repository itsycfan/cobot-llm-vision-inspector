...
"""
=============================================================================
Assembly Detection System - SIMPLIFIED VERSION 6.0 (Claude)
=============================================================================
Focus: 
...
Version: 6.0 (Simplified Result-Oriented) - Claude Edition
Date: 2025-10-28
=============================================================================
"""
...
class Config:
    ...
    # API
    ANTHROPIC_API_KEY: str = os.getenv("ANTHROPIC_API_KEY", "")  # Replace with your key
...
# =============================================================================
# 5. LLM ANALYZER (KEY COMPONENT - CLAUDE)
# =============================================================================

class LLMAnalyzer:
    """Claude-based analyzer with OPTIMIZED PROMPT"""
...
class DetectionSystem:
    ...
    def process_video(self, video_name: str) -> Optional[Result]:
        ...
        # Extract base name without extension for ground truth lookup
        video_base_name = Path(video_name).stem  # Removes extension (.mp4, .avi, .mov)
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"ASSEMBLY DETECTION SYSTEM V6.0 (Simplified - Claude Edition)")
    print(f"{'='*70}\n")
    ...
    if latest_video:
        ...
        print(f"❌ No video found to process")
